  ...
  return (
    <div className="flex items-center justify-between mb-4 space-x-3">
      <div className="grid grid-cols-2 rounded p-3px h-[46px]">
        <NavLink
          activeClassName="font-bold  text-high-emphesis border-yellow border-b-2 rounded-none text-high-emphesis  hover:text-blue"
          href={{
            pathname: '/swap',
        ...
        <NavLink
          activeClassName="font-bold  rounded text-high-emphesis border-b-2 border-yellow border-opacity-100 rounded-none text-high-emphesis  hover:text-blue"
