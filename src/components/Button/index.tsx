...
const FILLED = {
  ...
  max: 'bg-transparent opacity-80 hover:opacity-100 bg-gradient-to-br from-yellow to-opaque-yellow text-high-emphesis',
}
...
export type ButtonColor = 'blue' | 'pink' | 'gradient' | 'gray' | 'default' | 'red' | 'green' | 'max'
