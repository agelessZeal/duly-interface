...
function MISO() {
  ...
  return (
    <>
      <Head>
        <title>MISO | Duly</title>
        <meta key="description" name="description" content="MISO by Duly, an initial Duly offering on steroids ..." />
      </Head>
            ...
            <div className="gap-4 grid grid-cols-12 min-h-1/2 mb-6">
              ...
              <MisoArticles 
                ...
                content={`MISO is a suite of open-source smart contracts created to ease the process of launching 
                          a new project on the DulySwap exchange. MISO aims to drive new capital and trade to the exchange 
                          by increasing the attractiveness of DulySwap as a place for token creators and communities to launch 
                          new project tokens.`}
              />
            </div>
