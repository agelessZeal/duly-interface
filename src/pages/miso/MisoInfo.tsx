    ...
    <div className="flex flex-col">
      ...
      <div className="gap-4 grid grid-cols-12 mt-6">
        ...
        <div className="col-span-4 flex flex-col mx-auto">
          ...
          <div className="text-base md:text-xl font-bold text-white">{`${minRaised} $DULY`}</div>
      ...
      <div className="flex flex-col mt-6">
        <div>About</div>
        <div>The Trident NFT is introduced as a celebratory piece for the announcement and upcoming release of Duly’s Trident AMM. This NFT can be redeemed for a 19cm x 19cm 900 tab piece of blotter paper with this Chewy Stoll artwork on the left printed on it.</div>
      </div>
    </div>
  )
}
