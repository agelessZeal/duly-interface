        ...
        <Alert
          ...
          message={
            <>
              ...
              there may be very high slippage. ETH, WBTC, USDC, DAI and DULY are the safest tokens to zap with. If
...
export default function Zap() {
  ...
  return (
    <>
      <Head>
        <title>{i18n._(t`Zap`)} | Duly</title>
        <meta
          key="description"
          name="description"
          content="DulySwap allows for swapping of ERC20 compatible tokens across multiple networks"
        />
      </Head>
      {!poolAddress ? (
        <PoolList />
