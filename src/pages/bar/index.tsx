...
const buttonStyleEnabled = `${buttonStyle} text-high-emphesis bg-gradient-to-br from-pink-red to-light-brown hover:opacity-90`
...
export default function Stake() {
  ...
  const sushiBalance = useTokenBalance(account ?? undefined, DULY[ChainId.MAINNET])
  ...
  return (
    <>
      <Head>
        <title key="title">Stake | Duly</title>
        <meta
          key="description"
          name="description"
          content="Stake DULY in return for xSUSHI, an interest bearing and fungible ERC20 token designed to share revenue generated by all DULY products."
        />
        <meta key="twitter:url" name="twitter:url" content="https://app.sushi.com/stake" />
        <meta key="twitter:title" name="twitter:title" content="STAKE DULY" />
        <meta
        ...
        <meta key="og:title" property="og:title" content="STAKE DULY" />
          ...
          <div className="flex flex-col w-full max-w-xl mt-auto mb-2">
            <div className="flex max-w-lg">
              <div className="self-end mb-3 text-lg font-bold md:text-2xl text-high-emphesis md:mb-7">
                {i18n._(t`Maximize yield by staking DULY for xSUSHI`)}
              </div>
            ...
            <div className="max-w-lg pr-3 mb-2 text-sm leading-5 text-gray-500 md:text-base md:mb-4 md:pr-0">
              {i18n._(t`For every swap on the exchange on every chain, 0.05% of the swap fees are distributed as DULY
                                proportional to your share of the SushiBar. When your DULY is staked into the SushiBar, you recieve
                                ...
                                DULY and any additional from fees.`)}
            </div>
            {/* <div className="flex">
              ...
              <div className="w-full max-w-xl px-3 pt-2 pb-6 rounded bg-dark-900 md:pb-9 md:pt-4 md:px-8">
                ...
                <div className="flex items-center justify-between w-full mt-6">
                  <p className="font-bold text-large md:text-2xl text-high-emphesis">
                    {activeTab === 0 ? i18n._(t`Stake DULY`) : i18n._(t`Unstake`)}
                  </p>
                  <div className="border-gradient-r-pink-red-light-brown-dark-pink-red border-transparent border-solid border rounded-3xl px-4 md:px-3.5 py-1.5 md:py-0.5 text-high-emphesis text-xs font-medium md:text-base md:font-normal">
                    {`1 xSUSHI = ${xSushiPerSushi.toFixed(4)} DULY`}
                  </div>
                </div>
                ...
                <div className="relative w-full h-0 pointer-events-none bottom-14">
                  ...
                  >
                    <div className="flex space-x-2 ">
                      ...
                      >
                        {`${input ? input : '0'} ${activeTab === 0 ? '' : 'x'}DULY`}
                      </p>
                    </div>
                ...
                <div className="flex flex-col flex-grow">
                  ...
                  <div className="flex items-center ml-8 space-x-4 md:ml-0">
                    ...
                    <div className="flex flex-col justify-center">
                      ...
                      <p className="text-sm md:text-base text-primary">DULY</p>
                    </div>
                  </div>
                </div>
