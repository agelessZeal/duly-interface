...
const PERMITTABLE_TOKENS: {
  ...
  [1]: {
    ...
    [SUSHI[1].address]: { type: PermitType.AMOUNT, name: 'DulySwap' },
  },
  [4]: {
    ...
    [SUSHI[4].address]: { type: PermitType.AMOUNT, name: 'DulySwap' },
  },
  [3]: {
    [SUSHI[3].address]: { type: PermitType.AMOUNT, name: 'DulySwap' },
  ...
  [5]: {
    [SUSHI[5].address]: { type: PermitType.AMOUNT, name: 'DulySwap' },
  },
  [42]: {
    [SUSHI[42].address]: { type: PermitType.AMOUNT, name: 'DulySwap' },
  },
}
