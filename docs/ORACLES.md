...
Currently there is two types of oracles which the sushi interface supports, Chainlink & DulySwap TWAP.
...
Each price feed has a pair token0/token1, DULY/ETH or DULY/USD for example, decimals, and proxy. We use this information to construct mappings of the price feed to their respectful pair tokens.
